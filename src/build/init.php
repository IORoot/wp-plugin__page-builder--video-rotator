...
namespace andyp\pagebuilder\rotator\build;
...
class init {
    ...
    private function create_menu(){
        ...
        foreach ($this->config['rotator_instance'] as $key => $instance)
        {
            $menu .= $instance["rotator_menu"] . PHP_EOL;
        }
    ...
    private function create_content(){
        ...
        foreach ($this->config['rotator_instance'] as $key => $instance)
        {
            $content .= $instance["rotator_content"] . PHP_EOL;
        }
